  ...
  <PsrDialog @confirm="submitForm" @dismiss="$emit('dismiss')">
    ...
    <template #default>
      ...
      <div class="text-start" :class="{ error: form.errors.instagram }">
        <div class="rounded-md shadow-sm mt-4 relative">
          <div class="flex left-0 absolute top-0 bottom-0 items-center pl-3 text-gray-400 font-bold text-sm">
            @
          </div>
        ...
        <span v-if="form.errors.instagram" id="error-instagram" class="text-xs">
          Informe seu Instagram para ser notificado do sorteio
        </span>
      </div>
